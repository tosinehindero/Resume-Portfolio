            ...
            {PROJECTS.map((project, index) => (
               <div key={index} className="mb-12 flex flex-wrap lg:justify-center">
                  ...
                  <motion.div
                     ...
                     transition={{ duration: 0.5 }}
                     className="w-full lg:w-1/4 lg:px-4 flex justify-center lg:justify-start"
                  >
                     {" "}
                     {/* Add padding and center on small screens */}
                     <img
                        src={project.image}
                        width={150}
                        height={150}
                  ...
                  <motion.div
                     ...
                     className="w-full max-w-xl lg:w-3/4 lg:px-4"
                  >
                     {" "}
